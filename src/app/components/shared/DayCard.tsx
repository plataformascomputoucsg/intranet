  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 flex h-full w-full flex-col items-center justify-center gap-2.5 self-center">
        <div
          className={`self-stretch text-center font-['Poppins'] text-sm leading-4 font-medium ${
        ...
        <div
          className={`self-stretch text-center font-['Poppins'] text-2xl leading-4 font-medium ${
